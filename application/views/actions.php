            ...
            <div class="margins">
                ...
                <div class="center_block_wrap">
                    ...
                    <div id="center_top_menu" class="center_top_menu">
                        <ul>
                            <li id="ct_contacts" class="active"><i></i><?php echo $text['center_top_menu'][0]; ?></li>
                            <li id="ct_admin"><i></i><?php echo $text['center_top_menu'][1]; ?></li>
                        </ul>
                    </div><!-- .center_top_menu-->

                    <div id="center_block" class="center_actions_block">
                ...
                <div class="margins">
                    ...
                    <div class="bookmarks_menu">
                        ...
                        <div class="path">
                            ...
                            <a href="/actions" class="last"><?php echo $text['bookmarks'][1]; ?></a>
                        </div>
