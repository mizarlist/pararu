            ...
            <div class="register_main why_we_are_main">
                <div class="margins">
                    <div class="left_column">
                        <div class="left_column_in">
                            ...
                            <div class="text_block">
                                ...
                                <p>
                                    <?php echo $text['text_block'][2]; ?><span class="strong"><?php echo $text['text_block'][3]; ?></span><?php echo $text['text_block'][4]; ?>
                                </p>

                                <div class="h4"><?php echo $text['text_block'][5]; ?></div>
                    ...
                    <div class="right_column">
                        <img src="/images/why_we_are/why_we_page2.png" style="right: -28px;"/>
                    </div><!-- .right_column-->
            ...
            <div class="margins">
                <div class="bookmarks_menu">
                    <div class="path">
                        ...
                        <a href="<?php echo $links['whyweare_top'][1]; ?>" class="last"><?php echo $text['bookmarks_menu'][1]; ?></a>
                    </div>
