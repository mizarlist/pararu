            ...
            <div class="register_main why_we_are_main">
                <div class="margins">
                    <div class="left_column">
                        <div class="left_column_in">
                            ...
                            <div class="text_block">
                                ...
                                <div class="get_in_now get_in_now_wwr" style="margin-top: 193px;">
                    ...
                    <div class="right_column">
                        <img src="/images/why_we_are/why_we_page4.png" style="right: -28px;margin-top: -101px;"/>
                        <div class="img_txt">
                            <strong><?php echo $text['img_txt'][0]; ?></strong><?php echo $text['img_txt'][1]; ?>
                        </div>
                    </div><!-- .right_column-->
            ...
            <div class="margins">
                <div class="bookmarks_menu">
                    <div class="path">
                        ...
                        <a href="<?php echo $links['whyweare_top'][3]; ?>" class="last"><?php echo $text['bookmarks_menu'][1]; ?></a>
                    </div>
