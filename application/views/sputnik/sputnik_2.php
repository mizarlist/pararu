<img src="resource/noalbom_1.png" id="noalbom" style="display:none;margin-top:60px;margin-left:60px;"/>
<div class="reveal-modal-bg" style="display: none; "></div>
<div id="myModal"  align="center" class="reveal-modal" style="width:auto;padding:0px;background:white;margin-left:-410px;">

    <div  id="ponravilos" style="cursor:pointer;position:absolute;top:12px;left:33px;width:158px;height:19px;background-image:url('resource/ponravilos.png');" ></div>
    ...
    <div id="spisok_ponravilos" style="line-height: 1.5;padding:0px;position:absolute;border: 0px solid #999999;top: 40px;left: 20px;width:185px;height:0px;overflow:hidden;background:#ffffff">
        <div class="ponravilos_btn">Глаза</div>
        <div class="ponravilos_btn">Фигура</div>
        <div class="ponravilos_btn">Взгляд</div>
        <div class="ponravilos_btn">Улыбка</div>
        <div class="ponravilos_btn">Стиль</div>
        <div class="ponravilos_btn">Энергия</div>
        <div class="ponravilos_btn">Красивый фон</div>
        <div class="ponravilos_btn">Да... просто нравится!</div>
...
<div id="albums"  >
    ...
    <div class="center_block_title">Фотоальбомы</div>
