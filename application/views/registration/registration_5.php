...
<div class="step_micro_title"><?php echo $text['step_title_litle']; ?></div>
...
<div id="register_step3">
    ...
    <div id="register_go_next3"><?php echo $text['register_go_next5']; ?></div>

    <div style="display:none;" id="right_col_load">
        <div class="reg3_r_col">
            <div class="register_main_col_img">
                <img src="/images/temp_samples/reg_step_5_1.jpg" />
