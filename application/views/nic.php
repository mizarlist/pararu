            ...
            <div class="margins">
                ...
                <div class="center_block_wrap">
                    ...
                    <div id="center_top_menu" class="center_top_menu">
                        <ul>
                            <li id="ct_nic1" class="active"><i></i><?php echo $text['center_top_menu'][0]; ?></li>
                            <li id="ct_nic2"><i></i><?php echo $text['center_top_menu'][1]; ?></li>
                            <li id="ct_nic3"><i></i><?php echo $text['center_top_menu'][2]; ?></li>
                            <li id="ct_nic4"><i></i><?php echo $text['center_top_menu'][3]; ?></li>
                        </ul>
                    </div><!-- .center_top_menu-->

                    <div id="center_block" class="center_nic1_mode">
