...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/plugins/jcrop/css/jquery.Jcrop.css" />
        ...
        <script type="text/javascript" src="/plugins/uploadify/jquery.uploadify.v2.1.0.min.js"></script>
        ...
        <div id="content">
            <div class="margins">
                ...
                <div class="center_block_wrap">
                    ...
                    <div id="center_block" class="center_aboutme_block">
