                ...
                <div class="margins">
                        ...
                        <div class="left_column_in">
                            <div class="goods_menu tour_menu">
                                <ul>
                                    ...
                                    <li class="active"><a href="<?php echo $links['tour_top'][1]; ?>"><?php echo $text['goods_menu'][1]; ?></a><i></i></li>
                            ...
                            <div class="text_block">
                                ...
                                <div class="change_steps">
                                    <a class="go_prev" href="<?php echo $links['tour_top'][0]; ?>"><?php echo $text['prew_step']; ?></a>
                                    <a class="go_next" href="<?php echo $links['tour_top'][2]; ?>"><?php echo $text['next_step']; ?></a>
                                    <div class="clear"></div>
                                </div>
                    ...
                    <div class="right_column">
                        <div class="tour_img_col">
                            <div class="tour_img_col_img"><img src="/images/why_we_are/tour2.jpg" /></div>
            ...
            <div class="margins">
                <div class="bookmarks_menu">
                    <div class="path">
                        ...
                        <a href="<?php echo $links['tour_top'][1]; ?>" class="last"><?php echo $text['bookmarks_menu'][1]; ?></a>
                    </div>
