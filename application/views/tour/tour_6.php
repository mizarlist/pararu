                        ...
                        <div class="left_column_in">
                            <div class="goods_menu tour_menu">
                                <ul>
                                    ...
                                    <li class="active compl"><a href="<?php echo $links['tour_top'][4]; ?>"><?php echo $text['goods_menu'][4]; ?></a><i></i></li>
                                    <li class="active"><a href="<?php echo $links['tour_top'][5]; ?>"><?php echo $text['goods_menu'][5]; ?></a><i></i></li>
                                    <div class="clear"></div>
                                </ul>
                            </div>
...
<div class="why_we_are_arrow"></div>
<!--
                                <div class="change_steps">
                                    <a class="go_prev" href="<?php echo $links['tour_top'][4]; ?>"><?php echo $text['prew_step']; ?></a>
                                    <div class="clear"></div>
                                </div>
-->
                    ...
                    <div class="right_column">
                        <div class="tour_img_col">
                            <div class="tour_img_col_img"><img src="/images/why_we_are/tour6.jpg" /></div>
            ...
            <div class="margins">
                <div class="bookmarks_menu">
                    <div class="path">
                        ...
                        <a href="<?php echo $links['tour_top'][5]; ?>" class="last"><?php echo $text['bookmarks_menu'][1]; ?></a>
                    </div>
