...
class Ajax_Sputnik {
    ...
    public static function sputnik_centerblock($data) {
        ...
        if (in_array($data, $functions)) {
            return Controller_Sputnik::getSputnikCenterblock(array_search($data, $functions)+1);
        }
        return null;
    }
    ...
    public static function compare_centerblock($data) {
        ...
        if (in_array($data, $functions)) {
            return Controller_Sputnik::getCompareCenterblock(array_search($data, $functions)+1);
        }
        return null;
    }
